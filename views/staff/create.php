...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $staff->create($formData);
    
    if ($result['success']) {
        setFlashMessage('success', 'Staff member added successfully.');
        redirect("/views/users/create.php?staff_id=" . $result['id']);
    } else {
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="">
            ...
            <div class="flex justify-end space-x-4 mt-6">
                <a href="/views/staff/index.php" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition duration-300">
