...
$patientList = $db->fetchAll("SELECT * FROM patients $whereClause ORDER BY pat_id DESC", $params);
?>
...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/patients/create.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="" class="flex gap-4">
            ...
            <?php if ($search): ?>
                <a href="/patients/index.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300">
                        ...
                        <?php foreach ($patientList as $patient): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="/patients/view.php?id=<?php echo $patient['pat_id']; ?>" 
                                       class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="/patients/edit.php?id=<?php echo $patient['pat_id']; ?>" 
                                       class="text-yellow-600 hover:text-yellow-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="/patients/delete.php?id=<?php echo $patient['pat_id']; ?>" 
