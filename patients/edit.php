...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $sql = "UPDATE patients SET pat_first_name = :first_name, pat_last_name = :last_name, 
                    pat_email = :email, pat_phone = :phone, pat_date_of_birth = :dob, 
                    pat_gender = :gender, pat_address = :address, pat_emergency_contact = :emergency_contact, 
                    ...
                    pat_insurance_number = :insurance_number WHERE pat_id = :id";
