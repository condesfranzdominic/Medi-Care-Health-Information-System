...
if (!empty($search)) {
    $whereClause .= " AND a.appointment_id LIKE :search";
...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/appointments/create.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="" class="flex gap-4">
            ...
            <?php if ($search): ?>
                <a href="/appointments/index.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300">
                        ...
                        <?php foreach ($appointments as $appointment): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <a href="/appointments/edit.php?id=<?php echo urlencode($appointment['appointment_id']); ?>" 
                                       class="text-yellow-600 hover:text-yellow-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="/appointments/cancel.php?id=<?php echo urlencode($appointment['appointment_id']); ?>" 
