...
$services = $db->fetchAll("SELECT * FROM services ORDER BY service_name");
?>
...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <?php if ($auth->isSuperAdmin()): ?>
            <a href="/services/create.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
