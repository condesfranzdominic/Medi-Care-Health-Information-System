...
$staffList = $db->fetchAll("SELECT * FROM staff $whereClause ORDER BY staff_id DESC", $params);
?>
...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <?php if ($auth->isSuperAdmin()): ?>
            <a href="/staff/create.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="" class="flex gap-4">
            ...
            <?php if ($search): ?>
                <a href="/staff/index.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300">
                        ...
                        <?php foreach ($staffList as $staff): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="/staff/view.php?id=<?php echo $staff['staff_id']; ?>" 
                                       class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <?php if ($auth->isSuperAdmin()): ?>
                                        <a href="/staff/edit.php?id=<?php echo $staff['staff_id']; ?>" 
                                           class="text-yellow-600 hover:text-yellow-900">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="/staff/delete.php?id=<?php echo $staff['staff_id']; ?>" 
